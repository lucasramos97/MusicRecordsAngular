...
export class MusicService {
  ...
  public getAll(page = 1, size = 5): Observable<IPagedMusics> {
    return this.httpClient.get<IPagedMusics>(`${this.URL}?page=${page}&size=${size}`, this.HTTP_OPTIONS);
  }
  ...
  public update(music: IMusic): Observable<IMusic> {
    return this.httpClient.put<IMusic>(`${this.URL}/${music.id}`, music, this.HTTP_OPTIONS);
  }

  public delete(musicId: number | undefined): Observable<IMusic> {
    return this.httpClient.delete<IMusic>(`${this.URL}/${musicId}`, this.HTTP_OPTIONS);
  }
  ...
  public getAllDeleted(page = 1, size = 5): Observable<IPagedMusics> {
    return this.httpClient.get<IPagedMusics>(`${this.URL}/deleted?page=${page}&size=${size}`, this.HTTP_OPTIONS);
  }
  ...
  public definitiveDelete(musicId: number | undefined): Observable<void> {
    return this.httpClient.delete<void>(`${this.URL}/definitive/${musicId}`, this.HTTP_OPTIONS);
  }
